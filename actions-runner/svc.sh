...
SVC_NAME="actions.runner.mamta1998gola-AI-Chatbot.mamta-HP-Laptop-15s-du3xxx.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mamta1998gola-AI-Chatbot.mamta-HP-Laptop-15s-du3xxx)"
